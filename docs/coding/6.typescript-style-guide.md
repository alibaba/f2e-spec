...
![示例代码标注图](https://img.alicdn.com/tfs/TB1oE1BiAcx_u4jSZFlXXXnUFXa-660-371.svg)
...
- 【强制】禁止使用 `// tslint:<rule-flag>` 等类似的注释 [@typescript-eslint/ban-tslint-comment](https://github.com/typescript-eslint/typescript-eslint/blob/master/packages/eslint-plugin/docs/rules/ban-tslint-comment.md)
