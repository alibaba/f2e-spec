...
describe('Validate TS configs', () => {
  it('Validate eslint-config-ali/typescript', () => {
  ...
  it('Validate eslint-config-ali/typescript/react', () => {
    ...
    const errorReportedByTSPlugin = results.messages.filter(result => {
      return result.ruleId && result.ruleId.indexOf('@typescript-eslint/') !== -1;
    });
    assert.notEqual(errorReportedByReactPlugin.length, 0);
  ...
  it('Validate eslint-config-ali/typescript/rax', () => {
  ...
  it('Validate eslint-config-ali/typescript/vue', () => {
  ...
  it('Validate eslint-config-ali/essential/typescript', () => {
    ...
    // 验证一个风格问题被降级
    const styleErrors = results.messages.filter(result => {
      return result.ruleId === 'object-curly-spacing';
    });
    assert.equal(styleErrors[0].severity, 1);
  });

  it('Validate eslint-config-ali/essential/typescript/react', () => {
  ...
  it('Validate eslint-config-ali/essential/typescript/vue', () => {
  ...
  it('Validate eslint-config-ali/typescript/node', () => {
